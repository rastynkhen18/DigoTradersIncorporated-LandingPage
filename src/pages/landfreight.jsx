      ...
      <main className="flex flex-col justify-start items-start text-left w-full max-w-[1000px] p-6 gap-6">
        ...
        <div className='w-full rounded-2xl' style={{
          ...
          <section className='flex flex-row m-5'>
            <div className="p-5">
              <h2 className="text-4xl md:text-5xl font-bold text-[var(--primary-color)]">How Our Land Freight Process Works</h2>
...
Our team arranges pick-up at your location, ensuring safe handling from the start.</p>
              ...
              <div>
                <h3 className="text-3xl  font-bold text-[var(--white-color)]">2. City-to-City & Provincial Transport</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>We connect major cities and remote provinces with consistent service.</p>
              </div>

              <div>
                <h3 className="text-3xl font-bold text-[var(--white-color)]">3. Full Truckload (FTL) or Partial Loads (LTL)</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>Choose what fits your volume — shared or dedicated trucks.</p>
              </div>

              <div>
                <h3 className="text-3xl  font-bold text-[var(--white-color)]">4. Door-to-Door Cargo Movement</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>Direct pick-up and drop-off with real-time coordination.</p>
              </div>

              <div>
                <h3 className="text-3xl font-bold text-[var(--white-color)]">5. Documentation & Compliance</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>We take care of transport permits, waybills, and cargo labeling.</p>
              </div>
