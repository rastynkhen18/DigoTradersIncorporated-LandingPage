    ...
    return (
        <div>
            <main className="flex flex-col justify-start items-start text-left w-full max-w-3xl p-6 gap-6">
                ...
                <p className='text:base md:text-base'>Not sure what your cargo will cost to ship — or if you’re being charged too much? Unsure about taxes, duties, or customs tariffs? Our Freight & Tariff Consultation service helps you understand, plan, and optimize every peso of your shipping costs.</p>
                ...
                <div className='p-5 rounded-2xl' style={{
                    ...
                    <div className="mt-4 space-y-4">
                        <div>
                            ...
                            <p className='text-base md:text-base text-[var(--white-color)]'>We provide detailed cost breakdowns for land, sea, and air freight — local and international — so you can compare options and avoid overpaying.</p>
                        </div>

                        <div>
                            <h3 className="text-xl  font-bold text-[var(--white-color)]">2. Duties & Taxes Assessment</h3>
                            <p className='text-base md:text-base text-[var(--white-color)]'>We help you compute:
...
Know what you'll pay before your goods arrive — no more surprise fees.</p>
                        ...
                        <div>
                            ...
                            <p className='text-base md:text-base text-[var(--white-color)]'>We help classify your products using the Harmonized System (HS) for customs, so you get correct duties and avoid clearance issues.</p>
                        </div>

                        <div>
                            <h3 className="text-xl font-bold text-[var(--white-color)]">4. Customs Tariff Planning</h3>
                            <p className='text-base md:text-base text-[var(--white-color)]'>We guide you through government-imposed tariff rates — and show you how to legally reduce them via free trade agreements, exemptions, or reclassification.</p>
                        </div>
