        ...
        <div>
            <main className="flex flex-col justify-start items-start text-left w-full max-w-3xl p-6 gap-6">
                ...
                <div className='p-5 rounded-2xl' style={{
                    ...
                    <p className='text-base md:text-base text-[var(--white-color)]'>We assist clients in renewing their AMO certificates smoothly and on time by handling all document preparation, submission, and coordination with regulatory bodies.</p>
                    ...
                    <div className="mt-4 space-y-4">
                        <div>
                            ...
                            <p className='text-base md:text-base text-[var(--white-color)]'>We verify all required documents such as BOC forms, valid IDs, proof of appointment, etc.</p>
                        </div>

                        <div>
                            <h3 className="text-xl  font-bold text-[var(--white-color)]">2. Document Preparation & Filing</h3>
                            <p className='text-base md:text-base text-[var(--white-color)]'>We handle the proper formatting, notarization, and submission of your renewal documents to the Bureau of Customs.</p>
                        </div>

                        <div>
                            <h3 className="text-xl font-bold text-[var(--white-color)]">3. Follow-Up & Coordination</h3>
                            <p className='text-base md:text-base text-[var(--white-color)]'>We track the progress of your application and ensure it gets processed within the required timeline.</p>
                        </div>

                        <div>
                            <h3 className="text-xl font-bold text-[var(--white-color)]">4. Consultation for Updates & Compliance</h3>
                            <p className='text-base md:text-base text-[var(--white-color)]'>We advise on any changes in the AMO renewal process, including new rules, deadlines, or forms.</p>
                        </div>

                        <div>
                            <h3 className="text-xl font-bold text-[var(--white-color)]">5. Shipment Review & Cost Audit</h3>
                            <p className='text-base md:text-base text-[var(--white-color)]'>Already working with another forwarder? We can audit your current or past shipments to identify overcharges, miscalculations, or missed savings.</p>
                        </div>
                ...
                <div className="flex justify-center items-start flex-col mt-3 p-5 rounded-2xl" style={{
                    ...
                    <p className='text:base md:text-base text-[var(--white-color)]'>The AMO Certificate must typically be renewed annually or as required by the BOC (Bureau of Customs) guidelines.</p>
                    <p className='text:base md:text-base text-orange-700 font-bold'>We help you avoid last-minute rush and penalties by notifying you ahead of time.</p>
                </div>
