          ...
          <div className='p-5'>
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className='text-base md:text-base text-[var(--white-color)]'>We collect your goods from your supplier or warehouse
              ...
              <div>
                ...
                <p className='text-base md:text-base text-[var(--white-color)]'>We connect major cities and remote provinces with consistent service.</p>
              </div>

              <div>
                <h3 className="text-xl md:xl font-bold text-[var(--white-color)]">3. Full Truckload (FTL) or Partial Loads (LTL)</h3>
                <p className='text-base md:text-base text-[var(--white-color)]'>Choose what fits your volume — shared or dedicated trucks.</p>
              </div>

              <div>
                <h3 className="text-xl  font-bold text-[var(--white-color)]">4. Door-to-Door Cargo Movement</h3>
                <p className='text-base md:text-base text-[var(--white-color)]'>Direct pick-up and drop-off with real-time coordination.</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-[var(--white-color)]">5. Documentation & Compliance</h3>
                <p className='text-base md:text-base text-[var(--white-color)]'>We take care of transport permits, waybills, and cargo labeling.</p>
              </div>

              <div>
                <h3 className="text-xl  font-bold text-[var(--white-color)]">6. Delivery</h3>
                <p className='text-base md:text-base text-[var(--white-color)]'>We deliver your shipment to its final destination
