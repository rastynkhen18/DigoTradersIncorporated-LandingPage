			...
			<main className="flex flex-col justify-start items-start text-left w-full max-w-3xl p-6 gap-6">
				...
				<FadeInOnView>
					<p className="text-sm md:text-base">
						If you're planning to bring goods into the Philippines for business, getting accredited as an importer is mandatory. We help businesses—big or small—get their Import License and register
						with the Bureau of Customs (BOC) without the hassle.
					</p>
				</FadeInOnView>
						...
						<div className="mt-4 space-y-4">
							<FadeInOnView>
								<div>
									...
									<p className="text-sm md:text-base text-[var(--white-color)]">We prepare and review all required forms and documents such as BIR registration, business permits,</p>
								</div>
							</FadeInOnView>
							...
							<FadeInOnView>
								<div>
									...
									<p className="text-sm md:text-base text-[var(--white-color)]">
										We file your documents with the proper government agencies and guide you through BOC e2m (Electronic-to-Mobile)registration.
									</p>
								</div>
							</FadeInOnView>
							...
							<FadeInOnView>
								<div>
									...
									<p className="text-sm md:text-base text-[var(--white-color)]">We register your company on CPRS, which is required for processing import entries and customs clearance.</p>
								</div>
							</FadeInOnView>
							...
							<FadeInOnView>
								<div>
									...
									<p className="text-sm md:text-base text-[var(--white-color)]">Whether you're a sole proprietor or a corporation, we help coordinate requirements specific to your business type.</p>
								</div>
							</FadeInOnView>
							...
							<FadeInOnView>
								<div>
									...
									<p className="text-sm md:text-base text-[var(--white-color)]">From eligibility to final approval, we guide you through the entire process.</p>
								</div>
							</FadeInOnView>
