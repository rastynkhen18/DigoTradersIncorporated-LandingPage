			...
			>
				<section className="relative flex justify-center items-center flex-col h-[300px] bg-cover bg-center" style={{ backgroundImage: `url(${ServicesBackgroundImage})` }}>
					...
					<div className="relative text-center px-6 pt-16">
						<h1 className="text-xl md:text-3xl text-[var(--primary-color)] py-1 font-bold">SERVICES</h1>
						<p className="text-sm md:text-base text-[var(--white-color)]">Trusted logistics solutions tailored to meet industry standards and business demands.</p>
					</div>
				</section>
