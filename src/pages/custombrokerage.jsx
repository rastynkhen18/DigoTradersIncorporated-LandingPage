  ...
  return (
    <div className="flex justify-center">
      <main className="flex flex-col justify-start items-start text-left w-full max-w-3xl p-6 gap-6">
        ...
        <h2 className="text-2xl md:text-4xl font-bold">Smooth Borders. Fast Clearance. Zero Hassle.</h2>
        ...
        <div className='w-full rounded-2xl' style={{
          ...
          <section className='flex flex-row m-5'>
            <div className="p-5">
              <h2 className="text-4xl md:text-5xl font-bold text-[var(--primary-color)]">From Paperwork to Port — We Clear the Way for Your Cargo.</h2>
          ...
          <div className='p-5'>
            ...
            <div className="mt-4 space-y-4">
              <div>
                <h3 className="text-3xl font-bold text-[var(--white-color)]">1. Complete Documentation</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>We prepare all necessary import/export paperwork, permits, and customs declarations — fully compliant with Philippine and international regulations.</p>
              </div>

              <div>
                <h3 className="text-3xl  font-bold text-[var(--white-color)]">2. Taxes, Duties & Fees</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>We compute and process tariffs, VAT, and other duties — ensuring there are no surprises upon arrival.</p>
              </div>

              <div>
                <h3 className="text-3xl font-bold text-[var(--white-color)]">3. Customs Clearance</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>Our licensed brokers liaise directly with customs officials to get your cargo cleared fast and legally.</p>
              </div>

              <div>
                <h3 className="text-3xl  font-bold text-[var(--white-color)]">4. Regulatory Compliance</h3>
                <p className='text-base md:text-lg text-[var(--white-color)]'>We ensure your cargo meets all trade laws and government agency requirements (e.g., FDA, BOC, DA, DTI).</p>
              </div>
            </div>
          </div>
        ...
        <section className="mt-8 w-full">
          <h1 className="text-3xl font-bold w-full text-[var(--primary-color)]">Why It Matters</h1>
