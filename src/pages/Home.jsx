      ...
      <main >
        ...
        <section>
          ...
          >
            ...
            {/* Text Section */}
            <div className="flex flex-col gap-4 w-full md:w-1/2 p-5 md:p-14">
              <h1 className="text-[var(--white-color)] text-4xl md:text-5xl font-bold">
                📦 How It Works?
              </h1>
              <DropDownFAQ />
            </div>
        ...
        <section className='flex flex-col justify-center items-center' style={{
          background: 'linear-gradient(to top, var(--secondary-color), var(--secondary-accent), black)'
        }}>
          <h1 className="text-[var(--primary-color)] text-xl md:text-3xl font-bold p-5 text-center">
            All Set to Ship? Let's Get Moving!
          </h1>

          <div className="max-w-[1024px] gap-5 p-5 flex flex-col justify-center items-center md:flex-row">
            {/* Left: Contact Form */}
            <div className="flex flex-col w-full h-full gap-10  md:w-1/2">
              <div className="flex flex-col flex-grow p-6 bg-[var(--secondary-accent)] shadow-md rounded-lg border-4 border-[var(--primary-color)]">
...
const Home = () => {
	...
	return (
		<>
			<main>
				<section className="w-full h-[80vh] md:h-[70vh] bg-cover bg-center flex flex-col justify-center items-center" style={{ backgroundImage: `url(${HomePageBackground})` }}>
					<Header />
